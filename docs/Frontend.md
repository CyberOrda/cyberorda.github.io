...
* [Codegrazer: 7 Reflected Cross-site Scripting (XSS)](http://codegrazer.com/blog/7-reflected-xss.html)
* [X-XSS-Nightmare: 1; mode=attack XSS Attacks Exploiting XSS Filter](https://www.slideshare.net/masatokinugawa/xxn-en)
* [Constructing an XSS vector, using no letters - inventropy](https://inventropy.us/blog/constructing-an-xss-vector-using-no-letters)
* [PwnDizzle: XSS, Extensions and Content-Types](https://pwndizzle.blogspot.com/2015/07/xss-extensions-and-content-types.html)
* [Bypassing Ebay XSS Protection to launch XSS by...](https://whitehatnepal.tumblr.com/post/153333332112/xssonebay)
* [Persisting on Pornhub](https://blog.zsec.uk/persisting-pornhub/)
* [Story of a Parameter Specific XSS!](https://www.noob.ninja/2017/09/story-of-parameter-specific-xss.html)
...
* [Uber Bug Bounty: Turning Self-XSS into Good-XSS – Jack](https://whitton.io/articles/uber-turning-self-xss-into-good-xss/)
* [My "Public Evernote": Turning Self-XSS into Good XSS v2: Challenge Completed but Not Rewarded](https://httpsonly.blogspot.com/2016/08/turning-self-xss-into-good-xss-v2.html)
* [How I XSS’ed Uber and Bypassed CSP – Efkan – Medium](https://medium.com/@efkan162/how-i-xssed-uber-and-bypassed-csp-9ae52404f4c5)
* [XSS “403 forbidden” bypass write up – Nur A Alam Dipu – Medium](https://medium.com/@nuraalamdipu/xss-403-forbidden-bypass-write-up-e070de52bc06)
...
* [How we tookover shopify accounts with one single click | WeSecureApp | Research & Blog](https://wesecureapp.com/blog/how-we-tookover-shopify-accounts-with-one-single-click/)
* [Turning Self-XSS into non-Self Stored-XSS via Authorization Issue at “PayPal Tech-Support and Brand…](https://medium.com/@YoKoKho/turning-self-xss-into-non-self-stored-xss-via-authorization-issue-at-paypal-tech-support-and-brand-3046f52ac16b)
...
* [#152067 Stored XSS on developer.uber.com via admin account compromise](https://hackerone.com/reports/152067)
...
* [An overview of DOM XSS](https://ancat.github.io/web/xss/2012/05/26/an-overview-of-dom-xss.html)
* [DOM Based XSS - OWASP](https://www.owasp.org/index.php/DOM_Based_XSS)
* [Testing for DOM-based Cross site scripting (OTG-CLIENT-001) - OWASP](https://www.owasp.org/index.php/Testing_for_DOM-based_Cross_site_scripting_(OTG-CLIENT-001))
* [Combination of techniques lead to DOM Based XSS in Google.](https://sasi2103.blogspot.com/2016/09/combination-of-techniques-lead-to-dom.html)
...
* [A ghetto collection of XSS payloads ](https://d3adend.org/xss/ghettoBypass)
* [cujanovic/Markdown-XSS-Payloads: XSS payloads for exploiting Markdown syntax](https://github.com/cujanovic/Markdown-XSS-Payloads)
* [PayloadsAllTheThings/XSS injection at master · swisskyrepo/PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/XSS%20injection)

### Tools

* [evilcos/xssor2: XSS'OR - Hack with JavaScript.](https://github.com/evilcos/xssor2)
* [DanMcInerney/xsscrapy: XSS spider - 66/66 wavsep XSS detected](https://github.com/DanMcInerney/xsscrapy)
...
* [[CSP] On Reporting and Filtering | Dropbox Tech Blog](https://blogs.dropbox.com/tech/2015/09/on-csp-reporting-and-filtering/)
...
* [PortSwigger/csp-auditor: Burp and ZAP plugin to analyze CSP headers](https://github.com/portswigger/csp-auditor)
* [PortSwigger/csp-bypass: A Burp Plugin for Detecting Weaknesses in Content Security Policies](https://github.com/portswigger/csp-bypass)
...
* [How I bypassed Facebook CSRF once again! | Dynamic World](https://blog.darabi.me/2016/05/how-i-bypassed-facebook-csrf-in-2016.html)
* [Obtaining Login Tokens for an Outlook, Office or Azure Account – Jack](https://whitton.io/articles/obtaining-tokens-outlook-office-azure-account/)
* [Messenger.com Site-Wide CSRF – Jack](https://whitton.io/articles/messenger-site-wide-csrf/)
* [Stealing Facebook access_tokens using CSRF in device login flow - Josip Franjković](https://www.josipfranjkovic.com/blog/hacking-facebook-csrf-device-login-flow)
* [[PayPal BBP] I could’ve deleted All SMC messages. Using Brute-Force technique.](https://blog.ayoubaitelmokhtar.com/2018/06/paypal-bbp-i-couldve-deleted-all-smc.html)
* [Facebook GraphQL CSRF – These aren't the access_tokens you're looking for](https://philippeharewood.com/facebook-graphql-csrf/)
...
* [#245346 JSON CSRF on POST Heartbeats API](https://hackerone.com/reports/245346)
...
* [appsecco/json-flash-csrf-poc: This repo contains the files required to perform a CSRF attack using Flash and HTTP 307 redirections.](https://github.com/appsecco/json-flash-csrf-poc)

## Angular JS
* [Philippe De Ryck on Twitter: "How does the @OWASP top 10 impact #Angular applications? This #security cheat sheet covers a set of best practices for the 5 most relevant issues for @Angular apps.](https://twitter.com/PhilippeDeRyck/status/1042360699572379648)
...
* [Hunting postMessage Vulnerabilities](https://www.sec-1.com/blog/wp-content/uploads/2016/08/Hunting-postMessage-Vulnerabilities.pdf)
...
* [LinkedIn AutoFill Exposed Visitor Name, Email to Third-Party Websites | Lightning Security](https://lightningsecurity.io/blog/linkedin/)
* [The Mystery of postMessage – Ron Chan](https://ngailong.wordpress.com/2018/02/13/the-mystery-of-postmessage/)
...
* [#207042 Stealing contact form data on www.hackerone.com using Marketo Forms XSS with postMessage frame-jumping and jQuery-JSONP](https://hackerone.com/reports/207042)
* [#217745 XSS in $shop$.myshopify.com/admin/ via "Button Objects" in malicious app](https://hackerone.com/reports/217745)
...
* [WordPress Flash XSS in flashmediaelement.swf](https://gist.github.com/cure53/df34ea68c26441f3ae98f821ba1feb9c)
...
* [Advanced Flash Vulnerabilities in Youtube – Part 3 | OpnSec](https://opnsec.com/2017/08/advanced-flash-vulnerabilities-in-youtube-part-3/)
* [Advanced Flash vulnerabilities in Youtube – Part 4 | OpnSec](https://opnsec.com/2017/09/advanced-flash-vulnerabilities-in-youtube-part-4/)
* [#176308 Wordpress.com REST API oauth bypass via Cross Site Flashing](https://hackerone.com/reports/176308)
* [#164916 Same origin policy bypass on e.mail.ru via Cross-Site Flashing](https://hackerone.com/reports/164916)
* [#182160 XSS in IE11 on portswigger.net via Flash](https://hackerone.com/reports/182160)
...
* [#87040 XSS on OAuth authorize/authenticate endpoint](https://hackerone.com/reports/87040)
* [#199779 Google Analytics could be used as CSP bypass for data exfiltration on hackerone.com](https://hackerone.com/reports/199779)
...
* [Testing WebSockets (OTG-CLIENT-010) - OWASP](https://www.owasp.org/index.php/Testing_WebSockets_(OTG-CLIENT-010))
...
* [Detecting and exploiting path-relative stylesheet import (PRSSI) vulnerabilities | Blog](https://portswigger.net/blog/detecting-and-exploiting-path-relative-stylesheet-import-prssi-vulnerabilities)
* [RPO](http://www.thespanner.co.uk/2014/03/21/rpo/)
* [A few RPO exploitation techniques](https://www.mbsd.jp/Whitepaper/rpo.pdf)
