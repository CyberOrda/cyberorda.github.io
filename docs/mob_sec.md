...
* [Советы по безопасности](https://developer.android.com/training/articles/security-tips)
...
* [Руководство по тестированию безопасности мобильных устройств](https://mobile-security.gitbook.io/mobile-security-testing-guide/)
* [Шпаргалка по тестированию мобильных приложений на проникновение](https://github.com/sh4hin/MobileApp-Pentest-Cheatsheet)
...
* [Руководство по безопасности Android](https://developer.box.com/en/guides/security/)
...
* [Использование приложений и сети в Android](https://www.sans.org/cyber-security-summit/archives/file/summit-archive-1528491463.pdf)
...
* [APK Analyzer - инструмент для статического и виртуального анализа](https://github.com/sonyxperiadev/ApkAnalyser)
* [APK Inspector - мощный инструмент с графическим интерфейсом](https://github.com/honeynet/apkinspector/)
* [Droid Hunter - анализ уязвимостей Android-приложений и инструмент для пентеста Android](https://github.com/hahwul/droid-hunter)
* [Error Prone - инструмент статического анализа](https://github.com/google/error-prone)
* [Findbugs - Поиск ошибок в Java-программах](http://findbugs.sourceforge.net/downloads.html)
* [Find Security Bugs - плагин SpotBugs для аудита безопасности Java веб-приложений](https://github.com/find-sec-bugs/find-sec-bugs/)
* [Flow Droid - Статический трекер потоков данных](https://github.com/secure-software-engineering/FlowDroid)
* [Smali/Baksmali - Ассемблер/дизассемблер для формата dex](https://github.com/JesusFreke/smali)
...
* [Thresher - проверка свойств достижимости кучи](https://plv.colorado.edu/projects/thresher/)
* [Vector Attack Scanner - для поиска уязвимых точек для атаки](https://github.com/Sukelluskello/VectorAttackScanner)
* [Gradle Static Analysis Plugin](https://github.com/novoda/gradle-static-analysis-plugin)
* [Checkstyle - Инструмент для проверки исходного кода Java](https://github.com/checkstyle/checkstyle)
* [PMD - Расширяемый многоязычный статический анализатор кода](https://github.com/pmd/pmd)
...
* [Infer - Инструмент статического анализа для Java, C, C++ и Objective-C](https://github.com/facebook/infer)
...
* [Marvin - Анализирует Android-приложения и позволяет отследить приложение](https://github.com/programa-stic/marvin-django)
* [Inspeckage](https://github.com/ac-pm/Inspeckage)
* [PATDroid - Коллекция инструментов и структур данных для анализа Android-приложений](https://github.com/mingyuan-xia/PATDroid)
* [AndroL4b - виртуальная машина безопасности Android, основанная на ubuntu-mate](https://github.com/sh4hin/Androl4b)
* [Radare2 - Unix-подобный фреймворк для реверс-инжиниринга и инструменты командной строки](https://github.com/radareorg/radare2)
* [Cutter - бесплатная RE-платформа с открытым исходным кодом на базе radare2](https://cutter.re/)
...
* [Удаленная компрометация Android и iOS через ошибку в Wi-Fi чипсетах Broadcom](https://www.youtube.com/watch?v=TDk2RId8LFo)
* [Honey, I Shrunk the Attack Surface - Adventures in Android Security Hardening](https://www.youtube.com/watch?v=EkL1sDMXRVk)
* [Скрываем Android-приложения в изображениях](https://www.youtube.com/watch?v=hajOlvLhYJY)
* [Страшный код в сердце Android](https://www.youtube.com/watch?v=71YP65UANP0)
...
* [Обзор распространенных уязвимостей Android-приложений](https://www.bugcrowd.com/resources/webinars/overview-of-common-android-app-vulnerabilities/)
* [Android Dev Summit 2019](https://developer.android.com/dev-summit)
* [Архитектура безопасности Android](https://www.youtube.com/watch?v=3asW-nBU-JU)
...
* [Курсы тестирования Android на проникновение](https://medium.com/mobile-penetration-testing/android-penetration-testing-courses-4effa36ac5ed)
...
* [android-device-check - набор скриптов для проверки конфигурации безопасности Android-устройств](https://github.com/nelenkov/android-device-check)
* [apk-mitm - CLI-приложение, подготавливающее APK-файлы Android для проверки по HTTPS](https://github.com/shroudedcode/apk-mitm)
* [Andriller - программная утилита с набором криминалистических инструментов для смартфонов](https://github.com/den4uk/andriller)
* [Dexofuzzy: Метод кластеризации сходства вредоносных программ для Android с использованием последовательности опкодов](https://www.virusbulletin.com/virusbulletin/2019/11/dexofuzzy-android-malware-similarity-clustering-method-using-opcode-sequence/)
...
* [Динамический анализ iOS-приложений без джейлбрейка](https://medium.com/@ansjdnakjdnajkd/dynamic-analysis-of-ios-apps-wo-jailbreak-1481ab3020d8)
...
* [Checkra1n Era - серия](https://blog.digital-forensics.it/)
* [BFU Extraction: криминалистический анализ заблокированных и отключенных айфонов](https://blog.elcomsoft.com/2019/12/bfu-extraction-forensic-analysis-of-locked-and-disabled-iphones/)
* [HowTo-decrypt-Signal.sqlite-for-IOS](https://github.com/Magpol/HowTo-decrypt-Signal.sqlite-for-IOS)
* [Можно ли сделать джейлбрейк?](https://canijailbreak.com/)
* [Как извлечь пасскоды экранного времени и голосовые заметки из iCloud](https://blog.elcomsoft.com/2019/10/how-to-extract-screen-time-passcodes-and-voice-memos-from-icloud/)
...
* [Подход к пентестированию iOS-приложений во время выполнения](https://blog.securelayer7.net/a-run-time-approach-for-pen-testing-ios-applications-part-ii-objection-in-action/)
...
* [AirDoS: удаленно выводим из строя любой находящийся поблизости iPhone или iPad](https://kishanbagaria.com/airdos/)
* [Как получить доступ к файловой системе #checkra1n взломанного iPhone с помощью SSH](https://aboutdfir.com/jailbreaking-checkra1n-configuration/)
* [Глубокое погружение в цепочки iOS-эксплойтов, найденные в дикой природе - Project Zero](https://googleprojectzero.blogspot.com/2019/08/a-very-deep-dive-into-ios-exploit.html)
* [Полностью удаленная поверхность атак на iPhone - Project Zero](https://googleprojectzero.blogspot.com/2019/08/the-fully-remote-attack-surface-of.html)
...
* [Анализ и атаки на драйверы ядра Apple](https://www.youtube.com/watch?v=07VqX4bbXTI)
* [Удаленная компрометация iOS через Wi-Fi и побег из песочницы](https://www.youtube.com/watch?v=bP5VP7vLLKo)
...
* [KTRW: путешествие к созданию отлаживаемого iPhone](https://media.ccc.de/v/36c3-10806-ktrw_the_journey_to_build_a_debuggable_iphone)
* [Единственный странный трюк, который ненавидит SecureROM](https://media.ccc.de/v/36c3-11238-the_one_weird_trick_securerom_hates)
* [Tales of old: untethering iOS 11-Spoiler: Apple плохо справляется с патчами](https://media.ccc.de/v/36c3-11034-tales_of_old_untethering_ios_11)
...
* [osx-security-awesome - инструменты безопасности, связанные с OSX и iOS](https://github.com/ashishb/osx-and-ios-security-awesome)    
